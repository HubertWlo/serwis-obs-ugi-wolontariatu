...
//var connectionString = $"Data Source=zgloszenie_sql_server_container; Initial Catalog={dbName}; User Id=sa; Password={dbPassword};MultipleActiveResultSets=true;TrustServerCertificate=True;";
...
builder.Services.AddDbContext<ZgloszenieDbContext>(opt => opt.UseSqlServer(connectionString));
/* ===================================== */
