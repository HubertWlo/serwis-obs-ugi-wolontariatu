...
//var connectionString = $"Data Source=ogloszenie_sql_server_container; Initial Catalog={dbName}; User Id=sa; Password={dbPassword};MultipleActiveResultSets=true;TrustServerCertificate=True;";
...
builder.Services.AddDbContext<YourDbContext>(opt => opt.UseSqlServer(connectionString));
/* ===================================== */
