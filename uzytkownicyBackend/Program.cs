...
//var connectionString = $"Data Source=uzytkownik_sql_server_container; Initial Catalog={dbName}; User Id=sa; Password={dbPassword};MultipleActiveResultSets=true;TrustServerCertificate=True;";
...
builder.Services.AddDbContext<UzytkownikDbContext>(opt => opt.UseSqlServer(connectionString));
/* ===================================== */
